...
emcc -s WASM=1 -s ALLOW_MEMORY_GROWTH=1 --post-js jsinit.js -s EXPORTED_FUNCTIONS=@jslibexportedfunctions.json -O2 jslib.c libgit2.a -Isrc -I../src -I../include -o libgit2.js
